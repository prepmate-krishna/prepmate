...
import { supabaseClient } from "../lib/supabase"; // expects NEXT_PUBLIC_SUPABASE_URL + anon key
...
export default function AuthPage() {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      setMsg({ type: "success", text: "Signup initiated — check your email to confirm (if enabled)." });
      setEmail("");
      setPassword("");
    } catch (err) {
  ...
  // OAuth helpers (redirect to /generate after auth)
